# Generated by Powerlevel10k configuration wizard on 2025-06-28 at 19:49 CDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: compatible, rainbow, unicode, 12h time, flat heads, blurred tails,
# 2 lines, solid, left frame, lightest-ornaments, compact, fluent, transient_prompt,
